...
> [Giới thiệu ứng dụng (tiếng Việt)](../README.md) · [English setup and testing](#building) · [Hướng dẫn tiếng Việt](#hướng-dẫn-cài-đặt-và-kiểm-thử)
...
- [Download the latest CHAN demo APK](https://github.com/lystiger/CHAN/releases/latest/download/app-debug.apk)
- [Morning installation and phone setup](FRIEND_INSTALL.md)

This is a debug-signed APK for the private team demo, not a Play Store release.

Current build: **`0.3.1-sprint03`** (`versionCode` 4) — the Sprint 03 feature set
with the CHAN logo as the launcher icon.

Sprint 03 (`0.3.0-sprint03`) delivered speech reliability, truthful live
protection status, and repeated Zalo detections. See
`sprint-03-android-claude-code.md`.
